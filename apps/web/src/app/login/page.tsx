...
const loginCriticalCss = `
  *{box-sizing:border-box}
  ...
  @media(max-width:720px){.authPanel,.authFormCard{padding:18px}.authPanelTop{align-items:flex-start}.authCopy h1{font-size:38px}.authWorldSky,.authPokemonGif{min-height:190px}.authHighlights,.authWorldStats,.demoAccounts{grid-template-columns:1fr}.authForm{padding:18px}}
