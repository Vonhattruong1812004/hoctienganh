...
const loginCriticalCss = `
  *{box-sizing:border-box}
  ...
  .authPanelTop{position:absolute;top:clamp(24px,4vw,42px);left:clamp(28px,5vw,64px);right:clamp(28px,5vw,64px);z-index:2;display:flex;align-items:center;justify-content:space-between;gap:16px}.authPanelActions{display:flex;align-items:center;justify-content:flex-end;gap:10px;flex-wrap:wrap}
  ...
  @media(max-width:1120px){.authShell{grid-template-columns:1fr}.authPanel{min-height:520px;border-right:0;border-bottom:1px solid rgba(14,165,233,.2);padding-top:110px}.authFormCard{min-height:auto}}
  @media(max-width:720px){.authPanel,.authFormCard{padding:18px}.authPanel{min-height:auto;padding-top:18px}.authPanelTop{position:relative;top:auto;left:auto;right:auto;align-items:flex-start}.authPanelActions{justify-content:flex-start}.authCopy h1{font-size:24px}.authWorldCard{margin-top:4px}.authWorldSky,.authPokemonGif{min-height:190px}.authHighlights,.authWorldStats,.demoAccounts{grid-template-columns:1fr}.authForm{padding:18px}}
