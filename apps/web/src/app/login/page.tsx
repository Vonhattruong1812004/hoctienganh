...
const loginCriticalCss = `
  *{box-sizing:border-box}
  ...
  .authPanelTop{position:relative;z-index:1;display:flex;align-items:center;justify-content:space-between;gap:16px}.authPanelActions{display:flex;align-items:center;justify-content:flex-end;gap:10px;flex-wrap:wrap}
  ...
  @media(max-width:720px){.authPanel,.authFormCard{padding:18px}.authPanelTop{align-items:flex-start}.authPanelActions{justify-content:flex-start}.authCopy h1{font-size:24px}.authWorldCard{margin-top:-4px}.authWorldSky,.authPokemonGif{min-height:190px}.authHighlights,.authWorldStats,.demoAccounts{grid-template-columns:1fr}.authForm{padding:18px}}
