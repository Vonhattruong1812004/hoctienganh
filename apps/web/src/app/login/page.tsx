...
const loginCriticalCss = `
  *{box-sizing:border-box}
  ...
  .authWorldSky{position:relative;min-height:250px;border:1px solid rgba(255,255,255,.7);border-radius:8px;overflow:hidden;background:#bae6fd}.authZooSceneSvg{display:block;width:100%;min-height:250px;overflow:hidden;border-radius:inherit}.authZooGrid{fill:none;stroke:rgba(255,255,255,.28);stroke-width:1}.authZooRabbit,.authZooPenguin,.authZooTurtle,.authZooFish{transform-box:fill-box;transform-origin:center bottom}.authZooRabbit{animation:authZooRabbitHop 4.2s ease-in-out infinite}.authZooPenguin{animation:authZooPenguinWaddle 3.2s ease-in-out infinite}.authZooTurtle{animation:authZooTurtleMove 5.4s ease-in-out infinite}.authZooFish{animation:authZooFishSwim 3.4s ease-in-out infinite}.authZooFootLeft{animation:authZooFootTap .82s ease-in-out infinite}.authZooFootRight{animation:authZooFootTap .82s ease-in-out infinite reverse}
  ...
  @media(max-width:720px){.authPanel,.authFormCard{padding:18px}.authPanelTop{align-items:flex-start}.authCopy h1{font-size:38px}.authWorldSky,.authZooSceneSvg{min-height:190px}.authHighlights,.authWorldStats,.demoAccounts{grid-template-columns:1fr}.authForm{padding:18px}}
