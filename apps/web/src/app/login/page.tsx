...
const loginCriticalCss = `
  *{box-sizing:border-box}
  ...
  .authShell{position:relative;isolation:isolate;display:grid;grid-template-columns:minmax(0,1.08fr) minmax(430px,.92fr);min-height:100vh;overflow:hidden;background:radial-gradient(circle at 12% 16%,rgba(125,211,252,.72),transparent 0 330px),radial-gradient(circle at 38% 4%,rgba(254,240,138,.58),transparent 0 300px),radial-gradient(circle at 78% 20%,rgba(251,207,232,.66),transparent 0 360px),radial-gradient(circle at 86% 82%,rgba(196,181,253,.48),transparent 0 340px),radial-gradient(circle at 22% 88%,rgba(167,243,208,.56),transparent 0 310px),linear-gradient(135deg,#f8fdff 0%,#eef7ff 34%,#fff7ed 68%,#fdf2f8 100%)}
  .authBackdrop{position:absolute;inset:0;z-index:-1;pointer-events:none;overflow:hidden}
  .authBackdrop:before{content:"";position:absolute;inset:0;background:linear-gradient(118deg,rgba(255,255,255,.18) 0%,rgba(255,255,255,.58) 42%,rgba(255,255,255,.16) 100%);opacity:.74}
  .authGridGlow{position:absolute;width:360px;height:360px;border-radius:999px;filter:blur(54px);opacity:.38}
  .authGridGlowOne{left:-110px;top:10%;background:#22d3ee}.authGridGlowTwo{right:-120px;bottom:5%;background:#fb7185}
  .authPanel{position:relative;display:grid;align-items:center;gap:22px;padding:clamp(28px,5vw,64px);border-right:1px solid rgba(14,165,233,.22);background:radial-gradient(circle at 18% 20%,rgba(255,255,255,.82),transparent 0 280px),radial-gradient(circle at 75% 82%,rgba(187,247,208,.46),transparent 0 260px),linear-gradient(180deg,rgba(255,255,255,.72),rgba(236,254,255,.56));box-shadow:inset -1px 0 0 rgba(255,255,255,.68)}
  .authPanelTop{position:absolute;top:16px;left:16px;right:16px;z-index:2;display:flex;align-items:center;justify-content:space-between;gap:14px}.authPanelActions{display:flex;align-items:center;justify-content:flex-end;gap:10px;flex-wrap:wrap}
  .authBrand{display:flex;align-items:center;gap:12px;min-width:0;padding:8px 12px;border:1px solid rgba(255,255,255,.28);border-radius:8px;background:linear-gradient(135deg,rgba(15,23,42,.78),rgba(30,64,175,.62));box-shadow:0 14px 32px rgba(2,6,23,.22);backdrop-filter:blur(10px) saturate(145%)}.brandMark{display:grid;width:48px;height:48px;place-items:center;border-radius:8px;background:linear-gradient(135deg,#06b6d4,#2563eb 52%,#7c3aed);color:#fff;box-shadow:0 18px 38px rgba(37,99,235,.28),inset 0 1px 0 rgba(255,255,255,.34)}
  .authBrand strong{display:block;color:#f8fafc;font-size:22px;line-height:1.05}.authBrand span{display:block;color:#bae6fd;font-size:13px;font-weight:800}.themeToggle{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-height:44px;padding:0 16px;border:1px solid rgba(255,255,255,.34);border-radius:8px;background:linear-gradient(135deg,rgba(15,23,42,.82),rgba(30,64,175,.78));color:#f8fafc;font-weight:900;cursor:pointer;box-shadow:0 14px 30px rgba(2,6,23,.22)}
  ...
  .authFormCard{position:relative;display:grid;align-content:center;padding:clamp(24px,4.6vw,60px);background:radial-gradient(circle at 16% 18%,rgba(224,242,254,.72),transparent 0 260px),radial-gradient(circle at 90% 22%,rgba(253,230,138,.42),transparent 0 260px),radial-gradient(circle at 66% 88%,rgba(251,207,232,.48),transparent 0 280px),linear-gradient(180deg,rgba(255,255,255,.56),rgba(255,247,237,.48))}
  ...
  @media(max-width:1120px){.authShell{grid-template-columns:1fr}.authPanel{min-height:520px;border-right:0;border-bottom:1px solid rgba(14,165,233,.2)}.authFormCard{min-height:auto}}
  @media(max-width:720px){.authPanel,.authFormCard{padding:18px}.authPanel{min-height:auto}.authPanelTop{top:10px;left:10px;right:10px;align-items:flex-start;flex-direction:column}.authPanelActions{justify-content:flex-start}.authBrand{padding:7px 9px}.brandMark{width:42px;height:42px}.authBrand strong{font-size:18px}.authWorldCard{margin-top:4px}.authWorldSky,.authPokemonGif{min-height:240px}.authHighlights,.authWorldStats,.demoAccounts{grid-template-columns:1fr}.authForm{padding:18px}}
        ...
        <div className="authWorldCard" aria-label="Không gian học tập EnglishPro">
          <div className="authWorldSky">
            ...
            <div className="authPanelTop">
              ...
              <div className="authPanelActions">
                <ThemeToggleButton />
                <PwaInstallButton variant="onImage" />
              </div>
            </div>
          </div>
        </div>
